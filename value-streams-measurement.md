...
1. Navigate to and open the GitHub editor for the `Jenkinsfile` file in **development** branch of your forked **helloapp-api** repository <p><img src="img/streams/hwapi_dev_branch.png" width=800/>
...
6. Change the **base repository** to the **test** branch of your forked **helloapp-api** repository (not the **cloudbees-dwjw** repository), add a comment and then click the **Create pull request** button <p><img src="img/streams/metrics_dev_to_test_pr.png" width=700/>
...
11. Change the **base repository** to the **test** branch of your forked **helloapp-api** repository (not the **cloudbees-dwjw** repository), add a comment and then click the **Create pull request** button <p><img src="img/streams/metrics_dev_to_test_pr_fix.png" width=700/>
...
14. So now we are ready to merge to the **master** branch and release. Create another [Pull Request](https://help.github.com/en/articles/creating-a-pull-request) between the **test** branch and **master** branch of your forked **helloapp-api** repository. Navigate to your forked **helloapp-api** repository on the **test** branch in GitHub - click on the **New pull request** button<p><img src="img/streams/metrics_test_to_master_pr.png" width=700/>
