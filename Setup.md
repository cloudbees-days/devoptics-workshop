...
3. **Name this team** - enter a name for your team - **IMPORTANT: to ensure uniqueness, use {your GitHub username}** and then click **Next**;<p><img src="img/setup/setup-name-this-team.png" width=650/>
